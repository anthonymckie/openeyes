...
if [[ "$osver" == "14.04" ]]; then
	...
	# Ubuntu 16.04
	sudo wget -O wkhtml.deb https://github.com/wkhtmltopdf/packaging/releases/download/0.12.6-1/wkhtmltox_0.12.6-1.xenial_amd64.deb
elif [[ "$osver" == "18.04" ]]; then
	# Ubuntu 18.04
	sudo wget -O wkhtml.deb https://github.com/wkhtmltopdf/packaging/releases/download/0.12.6-1/wkhtmltox_0.12.6-1.bionic_amd64.deb
